 ...
 */
import { currentUser, announcements } from "@/lib/mockData";
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="hr-card p-4">
          <div className="flex items-start justify-between mb-3">
            <div
              ...
              style={{ background: "oklch(0.92 0.08 255)" }}
            >
              <User size={16} style={{ color: "oklch(0.42 0.18 255)" }} />
            </div>
          </div>
          <p className="text-xs font-medium mb-0.5" style={{ color: "oklch(0.55 0.012 65)" }}>
            Position
          </p>
        ...
        <div className="hr-card p-4">
          ...
          <p className="text-sm font-semibold" style={{ color: "oklch(0.22 0.012 65)", fontFamily: "'DM Sans', sans-serif" }}>
            Opens in {currentUser.evaluationOpensIn} days
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="hr-card p-5">
          ...
          <div className="space-y-2">
            {currentUser.pendingTasks.map((task, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full font-medium ${categoryColor[a.category] || "bg-gray-100 text-gray-600"}`}
                    >
                      {a.category}
                    </span>
                    <span className="text-xs" style={{ color: "oklch(0.65 0.01 65)" }}>
                      {new Date(a.date).toLocaleDateString("en-SG", { day: "numeric", month: "short" })}
                    </span>
                  </div>
