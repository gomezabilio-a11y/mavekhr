...
export const appRouter = router({
  ...
  employee: router({
    ...
    create: adminProcedure
      .input(z.object({
        ...
        employmentType: z.enum(["full-time", "part-time", "contract", "intern", "partner-firm"]).default("full-time"),
    ...
    update: adminProcedure
      .input(z.object({
        ...
        employmentType: z.enum(["full-time", "part-time", "contract", "intern", "partner-firm"]).optional(),
        workLocation: z.string().optional(),
  ...
  evaluation: router({
    ...
    createTask: adminProcedure
      .input(z.object({
        ...
        type: z.enum(["self", "peer", "manager", "contractor", "upward", "downward"]),
  ...
  evalForm: router({
    ...
    upsert: adminProcedure
      .input(z.object({
        formType: z.enum(["self_regular", "self_manager", "peer", "contractor", "upward_eval", "downward_eval"]),
        title: z.string().min(1),
